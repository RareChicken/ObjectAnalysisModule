...
if os.name == "nt":
    ...
    winGPUdll = os.path.join(cwd, "yolo_cpp_dll_gpu.dll")
...
#dll에 load_network_custom 함수가 존재하지 않음
...
def performDetect(imagePath="data/dog.jpg", thresh= 0.25, configPath = "./cfg/yolov3.cfg", weightPath = "yolov3.weights", metaPath= "./data/coco.data", showImage= True, makeImageOnly = False, initOnly= False):
    ...
    if netMain is None:
        ...
        netMain = load_net(configPath.encode("ascii"), weightPath.encode("ascii"), 0, 1)
    if metaMain is None:
